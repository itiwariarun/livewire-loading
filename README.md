...
The Laravel framework is open-sourced software licensed under the [MIT license](https://opensource.org/licenses/MIT).
 Run Migration and Add Dummy Data
...
composer require livewire/livewire
 Create Load More Component using Artisan
...
php artisan make:livewire loading-list
This command will create the following components on the following path:

app/Http/Livewire/LoadingList.php
resources/views/livewire/loading-list.blade.php
thn again migrate the data